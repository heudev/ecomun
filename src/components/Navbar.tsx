        ...
        <div className="navbar bg-[#0f216d] fixed z-10 lg:px-36">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        ...
                        <li className='rounded-lg bg-transparen'><a onClick={() => handleScroll('committees')}>Committees</a></li>
                        <li className='rounded-lg bg-transparent'><a onClick={() => handleScroll('schedule')}>Schedule</a></li>
                        <li className='rounded-lg bg-transparent'><a onClick={() => handleScroll('fees')}>Fees</a></li>
                        <li className='rounded-lg bg-transparent'><a onClick={() => handleScroll('faq')}>FAQ</a></li>
                        <li className='rounded-lg bg-transparent'><a onClick={() => handleScroll('contact')}>Contact</a></li>
            ...
            <div className="navbar-end hidden lg:flex">
                <ul className="menu menu-horizontal px-1 text-white">
                    ...
                    <li><a onClick={() => handleScroll('faq')} className='!bg-transparent'>FAQ</a></li>
                    <li><a onClick={() => handleScroll('contact')} className='!bg-transparent'>Contact</a></li>
