...
export default function Committees() {
    ...
    const committees = [
        ...
        },
        {
            ...
            agenda1: 'Scaling Up Green Innovation for Sustainable Industrial Transitions in Developing Countries',
            agenda2: 'Promoting renewable energy into developing global industries.',
            openAgenda: "",
            itemA: "",
            itemB: "",
        ...
        },
        {
            ...
            name: 'UNESCO',
            topic: 'Science, Technology and Innovation Policy for Sustainable Development',
            agenda1: 'Ensuring equitable access to digital technologies in developing countries',
            agenda2: 'Expanding affordable internet infrastructure and digital literacy programs',
            openAgenda: "",
            itemA: "",
            itemB: "",
            description: "UNESCO is a United Nations agency dedicated to advancing global collaboration in education, science, culture, and communication in order to promote peace around the world. The Organization supports its Member States by establishing international norms and standards, creating mechanisms for cooperation, generating research to guide public policy, and developing worldwide networks of recognized sites and institutions through its various lists.",
            level: 'Beginner',
        ...
        },
        {
            ...
            level: 'Intermediate',
            usgImageSrc: '/images/team/seda-elif.jpeg',
        ...
        },
        {
            ...
            itemA: "",
            itemB: "",
            description: 'The Congress of Vienna sought to restore stability in Europe after the Napoleonic Wars by reestablishing a balance of power and redrawing political borders answering ‘Eastern Question,’ including the declining Ottoman influence in the Middle East, and addressed early colonial and territorial disputes among major powers, aiming to prevent new conflicts through coordinated diplomacy',
            level: 'Intermediate',
        ...
        },
        {
            ...
            level: 'Advanced',
            usgImageSrc: '/images/team/yalin-ruzgar.jpeg',
            usgName: 'Yalın Menderes & Rüzgar Efe Taşın',
            usgOfCommittee: '',
            committeeGuide: ""
        },
        //----
        {
            ...
            openAgenda: '',
            agenda1: 'Establishing a durable ceasefire framework, preventing spillover into neighboring states and ensuring compliance with international humanitarian law.',
            agenda2: 'Arab led reconstruction efforts to restore essential infrastructure in Gaza and the West Bank, while strengthening Palestinian States trade, labor markets and institutions through regional economic cooperation.',
            itemA: "",
            itemB: "",
